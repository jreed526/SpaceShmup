...
public class Enemy_4 : Enemy { //Enemy_4 also extends the Enemy class
    ...
    public float duration = 4; //Duration of inerpolation movement
    ...
    public override void Move() {
        //This completely overrides Enemy.Move() with a linear inerpolation
    ...
    void OnCollisionEnter(Collision coll) {
        ...
        if(p != null) {
            ...
            if(bndCheck.isOnScreen) {
                ...
                //Find the EnemyShield that was hit (if there was once)
